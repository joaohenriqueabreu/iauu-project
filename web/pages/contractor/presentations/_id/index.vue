...
export default {
  ...
  computed: {
    ...
    presentationTabComponents() {
      return [
        { status: 'proposal',   icon: 'search-dollar',  title: 'Proposta',      component: ProposalSummary },
        { status: 'accepted',   icon: 'signature',      title: 'Contrato',      component: PresentationContract },
